...
CREATE TABLE IF NOT EXISTS `proveedor` (
	...
	`servicio` varchar(100) NOT NULL,                  -- Tipo de servicio ofrecido (ej: transporte, hospedaje)
	`celular` varchar(15) NOT NULL,                    -- Teléfono de contacto
	`correo` varchar(150) NOT NULL UNIQUE,             -- Correo electrónico único
...
CREATE TABLE IF NOT EXISTS `sede` (
	...
	`ciudad` varchar(100) NOT NULL,                -- Ciudad donde se ubica la sede
	PRIMARY KEY (`id_sede`)
);
...
CREATE TABLE IF NOT EXISTS `empleado` (
	...
	`cargo` varchar(100) NOT NULL,                    -- Cargo del empleado (ej: asesor, administrador)
	`celular` varchar(15) NOT NULL,                   -- Número de contacto
...
CREATE TABLE IF NOT EXISTS `reserva` (
	...
	`codigo_reserva` VARCHAR(20) NOT NULL UNIQUE,    -- Código alfanumérico único de la reserva (ej: R-2025-001)
...
CREATE TABLE IF NOT EXISTS `pago` (
	...
	`medio_pago` varchar(50) NOT NULL,               -- Medio de pago (ej: tarjeta, efectivo)
